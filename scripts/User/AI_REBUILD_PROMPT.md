# AI Rebuild & Architecture Directive: User / Deploy-NetworkStack
...
- Component / Script: Deploy-NetworkStack.ps1
- Category: User
- Language / Runtime: PowerShell 5.1 / 7+
- Architecture Role: Idempotent automation script operating within the User domain.
...
## Example AI Prompt
```markdown
Please review and rebuild the script Deploy-NetworkStack.ps1 in folder User:
